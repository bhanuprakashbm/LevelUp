        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Leading coaches and sports professionals rely on LevelUp for talent identification
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Sports Performance Assessment<br />
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:contact@levelup.gov.in" className="text-gray-400 hover:text-white transition-colors text-sm">contact@levelup.gov.in</a></li>
