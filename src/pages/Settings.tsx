...
import { seedFirestore, clearFirestore } from "@/lib/seedFirestore";
import { 
  User, 
  Shield, 
  Bell, 
...
export default function Settings() {
  ...
  const handleSeedDatabase = async () => {
    ...
    try {
      ...
      if (result.success) {
        toast.dismiss();
        toast.success(`Database seeded successfully! Added ${result.counts.athletes} athletes, ${result.counts.assessments} assessments, ${result.counts.states} states, and ${result.counts.sports} sports.`);
      }
    } catch (error) {
      toast.dismiss();
  ...
  const handleClearDatabase = async () => {
    ...
    try {
      ...
      toast.dismiss();
      toast.error('Failed to clear database. Please check console for details.');
